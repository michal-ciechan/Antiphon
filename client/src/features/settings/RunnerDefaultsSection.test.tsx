...
describe('RunnerDefaultsSection', () => {
  it('saves a cleared kind override with the current revision and keeps a stale draft', async () => {
    let body: { expectedRevision?: number; kindDefaults?: unknown[]; globalRunnerId?: string | null; reason?: string } | null = null
    server.use(
    ...
    await userEvent.selectOptions(screen.getByTestId('runner-defaults-kind-Codex'), '__inherit__')
