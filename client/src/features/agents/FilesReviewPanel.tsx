...
import {
  ...
  mergeTreePaths,
  viewModesFor,
  type FilesViewSelection,
  type FileViewMode,
  type TreeNode,
} from './filesReviewModel'
...
// FileViewMode / viewModesFor / defaultViewMode / FilesViewSelection moved to filesReviewModel.ts
// so this file only exports components (react-refresh). Types are re-exported for existing
// importers — type-only exports don't break fast refresh.
export type { FilesViewSelection, FileViewMode } from './filesReviewModel'
