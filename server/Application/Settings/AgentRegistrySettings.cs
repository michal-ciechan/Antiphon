...
public class AgentRegistrySettings
{
    ...
    /// <summary>
    /// CARD-0574 D-3. Compatibility key: a positive value is a once-per-wait diagnostic
    /// threshold after MCP is first observed. Zero suppresses that warning only. It does
