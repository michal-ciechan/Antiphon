...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AgentSupervisionState>(entity =>
        {
            ...
            entity.Property(s => s.RunnerBuildHeldIdentity).HasMaxLength(200);
            entity.Property(s => s.RunnerBuildHoldEvidence).HasMaxLength(1000);
        ...
        modelBuilder.Entity<AgentTaskLanding>(entity =>
        {
            entity.ToTable("AgentTaskLandings", table =>
            {
                table.HasCheckConstraint(
                    ...
                    "\"SchemaVersion\" <> 2 OR (\"ApprovalLandRequestId\" IS NOT NULL AND \"ReviewedSourceSha\" IS NOT NULL)");
                table.HasCheckConstraint(
