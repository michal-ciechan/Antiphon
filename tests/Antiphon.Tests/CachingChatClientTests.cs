...
public class CachingChatClientTests : IDisposable
{
    ...
    public void NormalizeContent_strips_iso8601_timestamps()
    {
        ...
        result.ShouldNotContain("2026-03-16T12:34:56Z");
    ...
    public void NormalizeContent_strips_uuids()
    {
        ...
        result.ShouldNotContain("a0000000-0000-0000-0000-000000000001");
        result.ShouldContain("<UUID>");
    }
    ...
    public void NormalizeContent_strips_git_shas()
    {
        ...
        result.ShouldNotContain("698a1a4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f");
        result.ShouldContain("<SHA>");
    }
    ...
    public void ComputeHash_is_deterministic()
    {
        ...
        hash1.Length.ShouldBe(64); // SHA256 hex string
    }
    ...
    public async Task RecordIfMissing_does_not_overwrite_existing()
    {
        ...
        cached.ShouldBe("original response");
    }
    ...
    public async Task Replay_mode_throws_on_cache_miss()
    {
        ...
        ex.Message.ShouldContain("Cache miss in Replay mode");
    }
    ...
    public async Task PassThrough_mode_never_reads_or_writes_cache()
    {
        ...
        Directory.Exists(_tempCacheDir).ShouldBeFalse();
    }
    ...
    public void Cache_files_stored_as_json_in_cache_directory()
    {
        ...
        client.CacheDirectory.ShouldBe(_tempCacheDir);
        client.Mode.ShouldBe(CacheMode.Record);
    }
}
