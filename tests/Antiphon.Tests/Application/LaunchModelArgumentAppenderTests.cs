...
public sealed class LaunchModelArgumentAppenderTests
{
    ...
    public void ForLaunch_maps_supported_ladders_and_omits_unsupported_kinds()
    {
        ...
        ModelLevelAliases.ForLaunch(AgentKind.Codex, AgentModelLevel.High).ShouldBe("gpt-6-sol");
        ...
        ModelLevelAliases.ForLaunch(AgentKind.Grok, AgentModelLevel.Low).ShouldBe("grok-4.7");
