...
Installed binary: Grok 1.0.13 (5e9a58528b76), SHA-256
`bf43dc75f5478a106eab1e86d422c963e4dbe9666cf14dab363733d27bf1e672`.
Supported disposable configuration: `session.auto_compact_threshold_percent = 1`.
Native read_file exchanges generated the context pressure. The Responses fixture's ordinary
usage envelope remains 10 input / 5 output tokens; no counters were inflated. These are native
CLI boundaries against a scripted summarizer, **not real-model retention/endurance evidence**.
