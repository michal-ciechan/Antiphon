...
Slack Socket Mode `IChannelAdapter` for the Antiphon messaging bus. Pair with
`Antiphon.Messaging.Gateway` to run a Slack gateway, or with `Antiphon.Messaging.Service`
