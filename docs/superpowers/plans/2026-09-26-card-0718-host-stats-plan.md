...
| CP-8 | S3 | n/a | client-hosts | `pwsh -NoProfile -File scripts/build-slot.ps1 -Label c718-client -- pwsh -File scripts/test-client.ps1 hosts` | V-10 | `CLIENT TESTS EXIT CODE: 0`, 5 files, 16 tests passed | n/a | 3 |
