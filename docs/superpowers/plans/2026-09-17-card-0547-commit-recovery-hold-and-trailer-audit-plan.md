...
| `-Refine` re-settlement | excluded (D-7, out of card); V-547-18 documents that a foreign-digest obligation survives a settlement unresolved. |
...
- `-Refine` re-settlement (D-7): V-547-18 documents the surviving foreign-digest row; no action.
...
|---|---:|---:|---:|
| C# controls, in-process or single-repo (all but the endpoint and Vitest rows) | 51 | 3.5 | 179 |
...
| **Mutation floor, all 54 controls, unbatched** | **54** | - | **226** |
