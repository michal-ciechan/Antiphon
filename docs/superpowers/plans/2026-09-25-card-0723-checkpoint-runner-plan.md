...
| CP-5 | S7 | CP-1 | contracts-and-script | `/*/*/(CheckpointToolProjectContractTests*)\|(DotnetToolManifestContractTests*)\|(RunCheckpointScriptTests*)/*` | V-19, R-4 | all listed, 0 failed | 21 | 5 |
| CP-5b | S7 | CP-1 | nightly-daily | `/*/*/NightlyVerificationContractTests/(C544_DailyValidity*)` | R-1 | the one method, 0 failed | 1 | 2 |
