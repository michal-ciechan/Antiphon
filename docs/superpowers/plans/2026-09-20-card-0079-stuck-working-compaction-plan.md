...
Current amendment (2026-09-22, Plan task `022820cb`): Review `3986b2f9` found 127 of the
217 PC selectors have no method. The [disposition amendment](#amendment-2026-09-22-disposition-of-the-127-missing-pc-methods)
below keeps 90 (10 with Code task `b976e9ae`), repoints 33 and retires 4 under
decisions D-11 through D-21, and carries the follow-up Code checkpoints CP-13 through CP-21.
Current next: **Code** (follow-up slices S-1 through S-6).
...
Amendment 2026-09-22 (Plan `022820cb`): the PC manifest is re-dispositioned in the
section that follows. Next stage is **Code** for slices S-1 through S-6 of that
amendment; the sibling Code task `b976e9ae` keeps D-1/D-3/PC-13. Its Review then
reconciles names; Mutation runs the 213 mapped cycles after land.
...
Amendment 2026-09-22 (`022820cb`) supersedes the manifest totals above: effective
guards 217, executable PC cycles 213, retired with decision 4 (PC-75/87/96/112),
missing mappings 0. Use its Checkpoints CP-13 through CP-21 for the follow-up Code
work; the sibling task `b976e9ae` runs CP-1 through CP-12. Current next: **Code**.
