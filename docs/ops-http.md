...
| Runner catalogue (CARD-0710) | GET | `/api/session-runners` lists desktop plus every configured runner: platform, availability, capacity and occupancy. One entry's failure does not drop the others. Unknown ids 404. |
