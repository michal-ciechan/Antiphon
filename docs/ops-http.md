...
| Create a task that runs on a runner (CARD-0604, CARD-0628) | POST | `/api/agent-tasks` with `runnerId` — Worktree + Grok or Claude Code, no pin/OnAgent/Shared/ReadOnly/SourceLanding (422 otherwise). The desktop worktree stays canonical; the runner gets a mirror. |
