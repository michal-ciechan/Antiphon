...
| Codex | `gpt-6-astra`, `gpt-6-sol`, `gpt-5.6-sol`, `gpt-5.6-terra`, `gpt-5.6-luna` | Suggestions remain unverified until the installed client or configured endpoint confirms them. `gpt-6-astra` requires codex-cli 0.153.4+, `gpt-6-sol` 0.156.1+. |
